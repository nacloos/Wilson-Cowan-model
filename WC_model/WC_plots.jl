...
for (i, E_ext) in enumerate(E_ext_values)
    ...
    if size(equilibria)[1] == 3
        if i >= 3
            ...
            plot(sol[1,:], sol[2,:], alpha=1, color="mediumaquamarine", linewidth=1.5)
            scatter(init_point..., marker=".", alpha=1, color="mediumaquamarine")
        end
        sn = equilibria[2]
        ...
        plot(sol[1,:], sol[2,:], alpha=1, color="coral", linewidth=1.5)
        scatter(init_point..., marker=".", alpha=1, color="coral")
        ...
        plot(sol[1,:], sol[2,:], alpha=1, color="#4A4A48", linewidth=1.5)
        scatter(init_point..., marker=".", alpha=1, color="#4A4A48")
    else
